...
void Playing_Laiya::onEnter()
{
    Layer::onEnter();
    this->_eventDispatcher->addCustomEventListener("playerjointable",CC_CALLBACK_1(Playing_Laiya::joinTable,this));

    this->_eventDispatcher->addCustomEventListener("playerleavetablebroadcast",CC_CALLBACK_1(Playing_Laiya::leaveTableBroadcast,this));
    this->_eventDispatcher->addCustomEventListener("PlayingBroadcast_BuHua",CC_CALLBACK_1(Playing_Laiya::buHuaBroadcast,this));
    this->_eventDispatcher->addCustomEventListener("playing_btn_chooseCard",CC_CALLBACK_1(Playing_Laiya::selectCard,this));
    this->_eventDispatcher->addCustomEventListener("playerout",CC_CALLBACK_1(Playing_Laiya::outCard,this));
    this->_eventDispatcher->addCustomEventListener("realoutcard",CC_CALLBACK_1(Playing_Laiya::outcardformserver,this));
    this->_eventDispatcher->addCustomEventListener("getsiglecardbroadcast",CC_CALLBACK_1(Playing_Laiya::systemgetsiglecardbroadcast,this));
    this->_eventDispatcher->addCustomEventListener("operateaskbroadcast",CC_CALLBACK_1(Playing_Laiya::responseoperate,this));
    this->_eventDispatcher->addCustomEventListener("operatesuccess",CC_CALLBACK_1(Playing_Laiya::resultofoperate,this));
    this->_eventDispatcher->addCustomEventListener("operatesuccessbroadcast",CC_CALLBACK_1(Playing_Laiya::responseoperatebroadcast,this));
    this->_eventDispatcher->addCustomEventListener("responseminglouask",CC_CALLBACK_1(Playing_Laiya::responseminglouask,this));
    this->_eventDispatcher->addCustomEventListener("responsemingloubroadcast",CC_CALLBACK_1(Playing_Laiya::responsemingloubroadcast,this));
    this->_eventDispatcher->addCustomEventListener("responseoneroundendbroadcast",CC_CALLBACK_1(Playing_Laiya::responseonroundendbroadcast,this));
    this->_eventDispatcher->addCustomEventListener("responsebreakbackbroadcast",CC_CALLBACK_1(Playing_Laiya::responsebreakbackbroadcast,this));
    this->_eventDispatcher->addCustomEventListener("playerreconnect",CC_CALLBACK_1(Playing_Laiya::responsereconnect,this));
    this->_eventDispatcher->addCustomEventListener("playing_broadcast_outCard",CC_CALLBACK_1(Playing_Laiya::outCardBroadcast,this));
    this->_eventDispatcher->addCustomEventListener("responsedismissask",CC_CALLBACK_1(Playing_Laiya::dismissAskBroadcast,this));
    this->_eventDispatcher->addCustomEventListener("responseplayeffect",CC_CALLBACK_1(Playing_Laiya::responsepalyeffect,this));
	this->_eventDispatcher->addCustomEventListener("chat",CC_CALLBACK_1(Playing_Laiya::responsechatbroadcast,this));
	this->_eventDispatcher->addCustomEventListener("customchat",CC_CALLBACK_1(Playing_Laiya::responsecustomchatbroadcast,this));
	this->_eventDispatcher->addCustomEventListener("responsedismisssuccessbroadcast",CC_CALLBACK_1(Playing_Laiya::dismisssuccessbroadcast,this));
	this->_eventDispatcher->addCustomEventListener("responsebreakbroadcast",CC_CALLBACK_1(Playing_Laiya::responsebreakbroadcast,this));
	this->_eventDispatcher->addCustomEventListener("responsereadybroadcast",CC_CALLBACK_1(Playing_Laiya::responsereadybroadcast,this));
	this->_eventDispatcher->addCustomEventListener("responseready",CC_CALLBACK_1(Playing_Laiya::responseready,this));
	this->_eventDispatcher->addCustomEventListener("responsegetplayerinfo",CC_CALLBACK_1(Playing_Laiya::responsegetplayerinfo,this));
	this->_eventDispatcher->addCustomEventListener("loseconnect",CC_CALLBACK_1(Playing_Laiya::losconnect,this));
	this->_eventDispatcher->addCustomEventListener("responsegetresulttotal",CC_CALLBACK_1(Playing_Laiya::addresulttotal,this));
	this->_eventDispatcher->addCustomEventListener("showresult3",CC_CALLBACK_1(Playing_Laiya::showresult3,this));
	
    this->_eventDispatcher->addCustomEventListener("restartbyconfirm",CC_CALLBACK_1(Playing_Laiya::restartbyLoseConfirm,this));

	this->_eventDispatcher->addCustomEventListener("responseresultpk",CC_CALLBACK_1(Playing_Laiya::responsepkbroadcast,this));
	this->_eventDispatcher->addCustomEventListener("showresultpk",CC_CALLBACK_1(Playing_Laiya::responseshowpk,this));
...
void Playing_Laiya::restartbyLoseConfirm(EventCustom *evt)
{
	restarapp_main(0);
}
void Playing_Laiya::responseshowpk(EventCustom *evt)
{
...
void Playing_Laiya::responsebreakbroadcast(EventCustom *evt)
{
...
void Playing_Laiya::responsepkbroadcast(EventCustom *evt)
{
...
void Playing_Laiya::restarapp_main(float dt)
{
...
void Playing_Laiya::losconnect(EventCustom *evt)
{
	bool* isShow = (bool*) evt->getUserData();
	if (*isShow)
	{
		tp_lose->setVisible(true);
		tp_lose->setZOrder(10000);
	...
	else
	{
		if (tp_lose)
		{
			...
			tp_lose->removeFromParent();
		}
	}
}
void Playing_Laiya::responsereconnect(EventCustom *evt)
{
    m_mjList.clear();
   ...
   nodeCards[3]->setVisible(true);
    ...
    for (int i = 0; i < 4; i++)
    {
		...
		{
			nodePlayer->setPosition(posWait[i]);
			if(g_m->getStatus()==5)
			{
		...
		{
			nodePlayer->setPosition(posGame[i]);
			if(g_m->getStatus()==3)
			{
...
void Playing_Laiya::playluxiang_player(std::vector<playluxiang> arr_luxiang)
{
...
void Playing_Laiya::refreshminglou(int viewid)
{
   
}
void Playing_Laiya::mingloufromluxiang(playluxiang p)
{
   

}
void Playing_Laiya::dispathercardsfromluxing(playluxiang p)
{
...
void Playing_Laiya::refreshjipaifromluxiang(int viewid)
{
...
void Playing_Laiya::chupaifomluxiang(playluxiang p)
{
        ...
        if(arr_shoupai[viewid].at(i)==p.cardid[0])
        {
			...
			if(p.cardid[0]==17)//这是张 鸡牌
			{
				if(right_ji_num_luxiang==0)//这是 冲锋鸡
				{
					...
					CallFunc *visible=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,hua,true));
					DelayTime *de=DelayTime::create(0.5*luxiang_rate);
					CallFunc *invisible=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,hua,false));
					CallFunc *nextstep=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::updateactions,this,0));
	...
	if(p.cardid[0]!=17)
	{
		...
		CallFunc *isvisible=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,sp_mj_out,true));
		CallFunc *invisible=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,sp_mj_out,false));
		...
		CallFunc *refreshout=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::refreshchupaifromluxiang,this,viewid));
		CallFunc *nextstep=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::updateactions,this,0));
...
void Playing_Laiya::refreshchupaifromluxiang(int viewid)
{
...
void Playing_Laiya::refreshshoupaifromluxiang(int viewid)
{
...
int Playing_Laiya::getlogicvalue(int a)
{
    return a/16*10+a%16;
}
void Playing_Laiya::mopaifromluxiang(playluxiang p)
{
    int card=p.cardid[0];
...
void Playing_Laiya::buhuafromluxiang(playluxiang p)
{
    int cardlen=p.cardlen;
    int uerid=p.actionuerid;
    int viewid=GetViewID(GamerData::getInstance()->getSeatId(),GamerDataDeal::getInstance()->getGamerData(uerid)->getSeatId());
...
void Playing_Laiya::leftchifromluxiang(playluxiang p)
{
...
void Playing_Laiya::refreshxingpaifromluxiang(int viewid)
{
...
void Playing_Laiya::minggangfromluxiang(playluxiang p)
{
    
}
void Playing_Laiya::angangfromluxiang(playluxiang p)
{
    
}
void Playing_Laiya::refreshzhishifromluxiang(int viewid)
{
	GameController * controlLayer22 = (GameController *)this->getChildByTag(119);
	controlLayer22->setArrowDirection(viewid);
}
void Playing_Laiya::nextstep(float dt)
{
...
void Playing_Laiya::updateactions(float dt)
{
    schedule(schedule_selector(Playing_Laiya::nextstep),2*luxiang_rate);
}
void Playing_Laiya::hufromluxiang(playluxiang p)
{
    int uerid=p.actionuerid;
    int provide=p.provideuserid;
...
void Playing_Laiya::initplayer()
{
    for(int i=0;i<4;i++)
    {
        nodePlayers[i]->setVisible(true);
        Node *n_player=(Node *)nodePlayers[i];
        n_player->setPosition(posGameluxiang[i]);
    ...
    //加载录像行牌界面
    Node *n_luxiang=CSLoader::createNode("res/loading/layer_luxiang.csb");
	...
	bt_back->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::removeluxiang,this));

	Button *bt_next=(Button *)sp_bg->getChildByName("Button_next");
	bt_next->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::nextfromluxiang,this));
	Button *bt_before=(Button *)sp_bg->getChildByName("Button_befor");
	bt_before->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::beforefromluxiang,this));
	bt_pause_luxiang=(Button *)sp_bg->getChildByName("Button_pause");
	bt_pause_luxiang->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::pausefromluxiang,this));
...
void Playing_Laiya::nextfromluxiang()
{
	if(luxiang_rate>0.1)
	{
...
void Playing_Laiya::beforefromluxiang()
{
	if(luxiang_rate<=3)
	{
		luxiang_rate=luxiang_rate+0.1;
...
void Playing_Laiya::pausefromluxiang()
{
	if(bt_pause_luxiang->getTag()==0)
	{
...
void Playing_Laiya::responsepalyeffect(EventCustom *evt)
{
...
void Playing_Laiya::removeluxiang()
{
    this->removeFromParent();

}
void Playing_Laiya::chushihua(bool isluxiang)
{
...
bool Playing_Laiya::init()
{
	...
	tp_lose->setVisible(false);
	 ...
	 touchListener->onTouchBegan = CC_CALLBACK_2(Playing_Laiya::onTouchBegan,this);//触摸开始
	 touchListener->onTouchMoved = CC_CALLBACK_2(Playing_Laiya::onTouchMoved,this);//触摸移动
	 touchListener->onTouchEnded = CC_CALLBACK_2(Playing_Laiya::onTouchEnded,this);//触摸结束
	 _eventDispatcher->addEventListenerWithSceneGraphPriority(touchListener,this);//注册分发器

    return true;
}
void Playing_Laiya::refreshOutcardByClickCard(int cardid)
{
	
}
bool Playing_Laiya::onTouchBegan(Touch* touch, Event *event)
{
	//遍历手里的牌看看点到了那张
...
void Playing_Laiya::onTouchMoved(Touch* touch, Event *event)
{
...
void Playing_Laiya::onTouchEnded(Touch* touch, Event *event)
{
		...
		if(m_mjList.size()>outcardingId)
		{
			if(m_mjList.at(outcardingId)->getIsCardSelected()==true)//牌已经被提起了就直接打出去
			{
				if(UserDefault::getInstance()->getBoolForKey("iscanoperatecard")==true&&m_mjList.at(outcardingId)->iscanoperateornot==true)
				{
					...
					iscanchupai=false;
					// scheduleOnce(schedule_selector(Playing_Laiya::recovercupai),1);
					for(int i=0;i<m_mjList.size();i++)
					{
...
void Playing_Laiya::recovercupai(float dt)
{
	iscanchupai=true;
}
//加载所有玩家显示初始化(玩家等待）
void Playing_Laiya::loadAndShowPlayers()
{
	...
	Node *n_all=CSLoader::createNode("res/loading/mj_main.csb");
	addChild(n_all);

	Sprite *sp_icon_wanfa=(Sprite *)n_all->getChildByName("text_wanfa_tag");
	sp_icon_wanfa->setVisible(true);
    ...
    for (int i = 0; i < 4; i++)
    {
		...
		mj_nodePLayer->setPosition(posWait[i]);
        ...
        if(i!=0)
        {
            nodeCards[i]->setVisible(false);
        }
        Button *bt_head=(Button *)nodePlayers[i]->getChildByName("Button_headclick");
        bt_head->setTag(i+1);
        bt_head->addTouchEventListener(CC_CALLBACK_2(Playing_Laiya::ButtonHandler,this));
    }
	for(int i=0;i<4;i++)
	{
...
void Playing_Laiya::setcards_detail_actionsisvisible(bool isvisible)
{
    node_detail_actions->setVisible(isvisible);
}
void Playing_Laiya::refreshactionsbutton(bool iscanoperate)
{
...
//按钮回调函数
void Playing_Laiya::ButtonHandler(Ref* pRef, ui::Widget::TouchEventType touchType)
{
...
void Playing_Laiya::responsegetplayerinfo(EventCustom *evt)
{
...
//游戏开始(玩家头像位置更新等)
void Playing_Laiya::startGame_gamePlayer(int banker, int left_card_cnt)
{
    isminglou_ing=false;
    isminglou_over=false;
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        nodePlayer->runAction(MoveTo::create(0.5f,posGame[i]));
...
void Playing_Laiya::getheadpathlocalbyurl(std::string url,int tag)
{
    cocos2d::network::HttpRequest* request = new cocos2d::network::HttpRequest();
    request->setUrl(url.c_str());
    request->setRequestType(cocos2d::network::HttpRequest::Type::GET);
    request->setResponseCallback(this, httpresponse_selector(Playing_Laiya::onGetFinished));
...
void Playing_Laiya::onGetFinished(cocos2d::network::HttpClient *sender, cocos2d::network::HttpResponse *response)
{
    if (!response)
    {
        return;
...
//玩家加入桌子fset
void Playing_Laiya::joinTable(EventCustom* evt)
{
    ...
    {//当前玩家
        ...
        btnUserInfo->addTouchEventListener(CC_CALLBACK_2(Playing_Laiya::ButtonHandler, this));
...
//玩家离开桌子广播
void Playing_Laiya::leaveTableBroadcast(EventCustom* evt)
{
...
void Playing_Laiya::responsebreakbackbroadcast(EventCustom *evt)
{
...
//玩家补花广播
void Playing_Laiya::buHuaBroadcast(EventCustom* evt)
{
	/*
...
//发牌
void Playing_Laiya::dispacherCard(google::protobuf::RepeatedField< ::google::protobuf::int32 > cards)
{
...
//当前玩家选中要出的牌(本地)
void Playing_Laiya::selectCard(EventCustom* evt)
{
    if (mj_selectedMj!=nullptr)
    {
...
void Playing_Laiya::selectCardbylocal(MjNode *mj)
{
...
//出牌(本地)
void Playing_Laiya::outCardBroadcast(EventCustom* evt)
{
    TableCommand::getInstance()->requestOutCard(mj_selectedMj->id);
}
void Playing_Laiya::spsetvisible(Sprite *sp,bool isvisible)
{
	sp->setVisible(isvisible);
}
void Playing_Laiya::outcardformserver(EventCustom *evt)
{
	refreshactionsbutton(false);
	...
	//	m_current_diamond->setPosition(Vec2(card_sp->getContentSize().width/2,y_diamond));
		...
		CallFunc *call=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::refreshoutcardByViewId,this,viewId));
		CallFunc *call_visible=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,sp_poker_out,true));
		CallFunc *call_unvisible=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,sp_poker_out,false));
		MoveTo *m_t=MoveTo::create(0,origin_position);
		Sequence *se1=Sequence::create(call_unvisible,m_t,nullptr);
		Sequence *se=Sequence::create(call_visible,action1,de1,action,se1,call,RotateTo::create(0,0),CallFunc::create(CC_CALLBACK_0(Playing_Laiya::playeeffect_normal,this,"audio_card.mp3")),nullptr);
        sp_poker_out->runAction(se);
        scheduleOnce(schedule_selector(Playing_Laiya::delayShowCurrentDiamond),0.8);
        hands_cnt[viewId]=hands_cnt[viewId]-1;
 ...
 void Playing_Laiya::delayShowCurrentDiamond(float dt)
 {
	 m_current_diamond->setVisible(true);
 }
void Playing_Laiya::minglououtcarddelay(float dt)
{
	SEND_CUSTOM_MSG("playing_broadcast_outCard");
}
void Playing_Laiya::systemgetsiglecardbroadcast(EventCustom *evt)
{
        ...
        if(userid==GamerData::getInstance()->getUId())//当前玩家是自己
        {
			...
			if(isminglou_over)
			{
                if(!ishu)//这张牌不能胡
                {
					...
					scheduleOnce(schedule_selector(Playing_Laiya::minglououtcarddelay),0.5);
                }
            }
        }
        else
...
void Playing_Laiya::responseoperate(EventCustom *evt)
{
    arr_operates.clear();
    ...
    for(int i=0;i<actions.size();i++)
    {
        ...
        if(actions.Get(i)!=0)
        {
             if(actions.Get(i)==operate_showpeng)//碰牌
            {
                ...
                arr_actions[button_num-1]->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::peng_callfunc,this,operate_showpeng,actioncard));
            }
            else if(actions.Get(i)==operate_showgang)//杠牌
            {
                ...
                arr_actions[button_num-1]->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::gang_callfunc,this,arr_gang));
            ...
            else if(actions.Get(i)==operate_showting)//听牌
            {
                ...
                arr_actions[button_num-1]->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::minglou_callfunc,this));//此处进行听牌操作
            }
            else if(actions.Get(i)==operate_showhu)//胡牌
            {
                ...
                arr_actions[button_num-1]->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::hu_callfunc,this,actioncard));
            }
        }
    }
    ...
    arr_actions[button_num]->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::guo_callfunc,this));
...
//操作结果
void Playing_Laiya::resultofoperate(EventCustom *evt)
{
...
void Playing_Laiya::hupai_yinxiao(int op,int sex_)
{
	Tools::playOperateByGender(op,sex_);
}
void Playing_Laiya::playeeffect_normal(std::string path)
{
	Tools::playEffect(path.c_str());
}
//操作结果广播
void Playing_Laiya::responseoperatebroadcast(EventCustom *evt)
{
       ...
       // Tools::playOperateByGender(operatecode, p->getSex());
		...
		else  if(operatecode==8)//胡
		{
			...
			if(uid==provideuid) 
			{
				...
				CallFunc *call=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::hupai_yinxiao,this,10,p->getSex()));
				Sequence *se=Sequence::create(de,call,CallFunc::create(CC_CALLBACK_0(Playing_Laiya::removeSp,this,sp_)),nullptr);
				sp_->runAction(se);
			}
			else
			{
...
void Playing_Laiya::playAction_hu_animation()
{
	...
	for(int i=0;i<arr_hutype.size();i++)
	{
		 ...
		 if(hu_t.gangtype!=0)
		 {
			 ...
			 //放杠的动画 然后再放胡的动画 
             CallFunc *call_gang=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::playAction_gang_animationSigle,this,hu_t.viewid,hu_t.gangtype));
			 DelayTime *de_gang=DelayTime::create(1);
			 CallFunc *call_hu=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::playAction_hu_animationSigile,this,hu_t.viewid,hu_t.hutype));
			 DelayTime *de_hu=DelayTime::create(1);
			 CallFunc *call_remove=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::removeSp,this,sp_temp_));
	...
	if(arr_hutype.size()>1)
	{
		...
		CallFunc *call_yipao=CallFunc::create(CC_CALLBACK_0(Playing_Laiya::playAction_YipaoDuoxiangAnimation,this,arr_hu_viewid,arr_hutype.size()));
...
void Playing_Laiya::removeSp(Sprite *sp)
{
	sp->removeFromParent();
}
void Playing_Laiya::showRresultLayerByOverAnimation(float dt)
{
	cleanallscene();
...
void Playing_Laiya::playAction_YipaoDuoxiangAnimation( std::vector<int >arr_hu_viewids,int hu_num)
{
	
}
void Playing_Laiya::playAction_gang_animationSigle(int viewid,int gang_type)
{
	...
	Sequence *se=Sequence::create(CallFuncN::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,sp_action_animation,true)),DelayTime::create(0.5),CallFuncN::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,sp_action_animation,false)),nullptr);
	sp_action_animation->runAction(se);
}
void Playing_Laiya::playAction_hu_animationSigile(int viewid,int hu_type)
{
	Sprite *sp_action_animation=(Sprite *)nodePlayers[viewid]->getChildByName("icon_action_animation");
	sp_action_animation->setVisible(true);
	if(hu_type==1)
...
void Playing_Laiya::playeraction_animation(int viewid,int operatecode)
{
    Sprite *sp_action_animation=(Sprite *)nodePlayers[viewid]->getChildByName("icon_action_animation");
    ...
    Sequence *se=Sequence::create(CallFuncN::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,sp_action_animation,true)),DelayTime::create(0.2),st1,st,CallFuncN::create(CC_CALLBACK_0(Playing_Laiya::spsettexture,this,sp_action_animation,texturepath)),DelayTime::create(0.8),CallFuncN::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,sp_action_animation,false)),ScaleTo::create(0,1.0),nullptr);
    sp_action_animation->runAction(se);
}
void Playing_Laiya::spsettexture(Sprite *sp,std::string path)
{
	sp->setTexture(path.c_str());
}
void Playing_Laiya::playAction_jiAnimation(int viewid,int jitype)
{
	Sprite *sp_action_animation=(Sprite *)nodePlayers[viewid]->getChildByName("icon_action_animation");
...
void Playing_Laiya::sp_visible(Sprite *sp,bool isvisible)
{
    sp->setVisible(isvisible);
}
void Playing_Laiya::refreshjipaiOfPlayer(int viewid)
{
	Node *node_jipai=nodeCards[viewid]->getChildByName("node_ji");
...
void Playing_Laiya::refreshoutcardByViewId(int viewid)
{
	//刷新玩家打出的牌
...
void Playing_Laiya::refreshxingpaiposofothers(std::vector<operate_result>arr_mjs,Node *parent,int viewid ,int ismopai)
{
    //手牌重新整理
	if(ismopai==0)
	{
...
void Playing_Laiya::sortpokersbywhx(std::vector<MjNode *>arr_mjs)
{
...
void Playing_Laiya::sortMjByLaiya(std::vector<int > &arr_mjs)
{
	std::sort(arr_mjs.begin(), arr_mjs.end(), [](int a,int b){
		return a<b;
	});
}
void Playing_Laiya::sortMjByLaiya_cardshow(std::vector<int> &arr_poker)
{
	std::sort(arr_poker.begin(), arr_poker.end(), [](int a,int b){
		return a>b;
	});
}
void Playing_Laiya::refreshxingpaipos(std::vector<operate_result>arr_poker, Node *parent)
{
	int pos_origin_x=0;
...
//碰牌回调
void Playing_Laiya::peng_callfunc(int opreratecode,int action_card)
{
    TableCommand::getInstance()->requestoperate(opreratecode,action_card);
}
//杠牌回调
void Playing_Laiya::gang_callfunc(std::vector<operate_me>gang_arr)
{
    if(gang_arr.size()!=0)
    {
        if(gang_arr.size()==1)
...
//胡牌回调
void Playing_Laiya::hu_callfunc(int actioncard)
{
    TableCommand::getInstance()->requestoperate(7,actioncard);
}
//明楼回调
void Playing_Laiya::minglou_callfunc()
{
    //点击明楼 要发起请求
    TableCommand::getInstance()->requestminglouask();
}
void Playing_Laiya::responseready(EventCustom *evt)
{
...
void Playing_Laiya::responsereadybroadcast(EventCustom *evt)
{
...
void Playing_Laiya::responseminglouask(EventCustom *evt)
{
    refreshactionsbutton(false);
...
void Playing_Laiya::responsemingloubroadcast(EventCustom *evt)
{
...
void Playing_Laiya::responseonroundendbroadcast(EventCustom *evt)
{
	//数据
	...
	if(arr_hutype.size()!=0)
	{
		...
		scheduleOnce(schedule_selector(Playing_Laiya::showfanpaiji),time_all);
		time_all=time_all+3;
	}
	
	//展示结果界面
	scheduleOnce(schedule_selector(Playing_Laiya::showRresultLayerByOverAnimation),time_all);

}
void Playing_Laiya::refreshcard_show(oneroundresult r_show)
{
...
void Playing_Laiya::showfanpaiji(float dt)
{
...
void Playing_Laiya::dismisssuccessbroadcast(EventCustom *evt)
{
	diamisssuccess=2;
}
void Playing_Laiya::dismissAskBroadcast(EventCustom *evt)
{
    //数据
...
void Playing_Laiya::refreshhead()
{
    for(int i=0;i<4;i++)
    {
        nodePlayers[i]->setVisible(true);
...
//显示可以吃的牌
void Playing_Laiya::showcards_chi(std::vector<operate_me > chi_arr)
{
    refreshactionsbutton(false);
    ...
    for(int i=0;i<chi_arr.size();i++)
    {
        ...
        bt_call_chi->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::chi_final_request,this,chi_arr[i].operatecode,arr_cars));
    }
}
void Playing_Laiya::chi_final_request(int opcode,std::vector<int >arr_cards)
{
    TableCommand::getInstance()->requestoperate(opcode,arr_cards[0]);
    setcards_detail_actionsisvisible(false);
}
//显示可以杠的牌
void Playing_Laiya::showcards_gang(std::vector<operate_me>gang_arr)
{
    setcards_detail_actionsisvisible(true);
    ...
    for(int i=0;i<gang_arr.size();i++)
    {
        ...
        arr_cars.push_back(mj_real_value);
        arr_cars.push_back(mj_real_value);
        bt_call_chi->addClickEventListener(CC_CALLBACK_0(Playing_Laiya::chi_final_request,this,gang_arr[i].operatecode,arr_cars));
    }
}
//直接吃牌
void Playing_Laiya::operate_chi(operate_me op)
{
...
//杠牌
void Playing_Laiya::oprate_gang(operate_me op)
{
    int opcode=op.operatecode;
    int cardid=op.card_id;
...
//当前玩家出牌返回（服务器）
void Playing_Laiya::outCard(EventCustom* evt)
{
...
//刷新麻将位置
void Playing_Laiya::refreshMjsPos()
{
...
///排列pMjNode 从大到小
void Playing_Laiya::sortMjs(Vector<MjNode*> &_pokerVec)
{
...
//补花动画显示并且修改其数量
void Playing_Laiya::buhuaActionManage(int uid,int numHua)
{
    auto action = Sequence::create(DelayTime::create(1.0f),FadeOut::create(0.25f),CallFuncN::create( CC_CALLBACK_1(Playing_Laiya::buHuaActionEndcallback, this)),nullptr);
...
//补花提示icon显示结束
void Playing_Laiya::buHuaActionEndcallback(Node* sender )
{
    sender->setVisible(false);
    sender->setOpacity(255);
}
//出牌本地动画结束后的回调函数
void Playing_Laiya::outCard1Action(Node* sender )
{
    MjNode* card = (MjNode*)sender;
    TableCommand::getInstance()->requestOutCard(card->id);
}
void Playing_Laiya::setcardoperateornot(bool is)
{
    for(int i=0;i<m_mjList.size();i++)
    {
...
void Playing_Laiya::cleanallscene()
{
...
void Playing_Laiya::playEffectCustom(std::string kName,int viewid)
{
    ...
    log("%s",kName.c_str());
    experimental::AudioEngine::setFinishCallback(custom_id,CC_CALLBACK_0(Playing_Laiya::on_effect_over,this,viewid));

}

void Playing_Laiya::on_effect_over(int viewid)
{
	if(viewid==0)
	{
		UserDefault::getInstance()->setBoolForKey("isplayluyin",false) ;
...
void Playing_Laiya::responsechatbroadcast(EventCustom *evt)
{
	...
	if(UserDefault::getInstance()->getBoolForKey("isplayluyin")==false)
	{
		if(index>100&&index<200)
		{
			...
			sp->setVisible(false);
			addChild(sp);
			Sequence *se=Sequence::create(DelayTime::create(2.0f),CallFunc::create(CC_CALLBACK_0(Playing_Laiya::recoverchat,this,viewid,sp)),nullptr);
		    sp->runAction(se);
			GamerData *g=GamerDataDeal::getInstance()->getGamerData(uid);
	...
	if(index>200)
	{
		...
		RepeatForever *re=RepeatForever::create(an);
		emoji->runAction(re);
		Sequence *se=Sequence::create(DelayTime::create(2.0f),CallFunc::create(CC_CALLBACK_0(Playing_Laiya::sp_visible,this,emoji,false)),nullptr);
		emoji->runAction(se);
	}
}
void Playing_Laiya::recoverchat(int viewid,Sprite *sp)
{
	UserDefault::getInstance()->setBoolForKey("isplayluyin",false); 
...
void Playing_Laiya::responsecustomchatbroadcast(EventCustom *evt)
{
...
void Playing_Laiya::initcardWithCardIds(Sprite *sp_card,int cardid)
{
